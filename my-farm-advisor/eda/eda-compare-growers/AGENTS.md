...
This folder owns the cross-grower comparison EDA workflow for evaluating field boundaries, CDL/cropland, and weather across multiple growers in Assignment 2.
